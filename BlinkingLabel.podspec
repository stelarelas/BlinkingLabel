...
This CocoaPod provides the ability to use a UILabel that may be started and stopped blinking.
  ...
  s.homepage         = 'https://github.com/stelarelas/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SteliosD' => 'stelios24@gmail.com' }
  s.source           = { :git => 'https://github.com/stelarelas/BlinkingLabel.git', :tag => s.version.to_s }
